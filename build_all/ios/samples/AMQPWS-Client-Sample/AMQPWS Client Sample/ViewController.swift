...
class ViewController: UIViewController {
    ...
    private let iotProtocol: IOTHUB_CLIENT_TRANSPORT_PROVIDER = AMQP_Protocol_over_WebSocketsTls
    ...
    @IBAction func startSend(sender: UIButton!) {
        ...
        timerDoWork = Timer.scheduledTimer(timeInterval: 0.2, target: self, selector: #selector(dowork), userInfo: nil, repeats: true)
    }
