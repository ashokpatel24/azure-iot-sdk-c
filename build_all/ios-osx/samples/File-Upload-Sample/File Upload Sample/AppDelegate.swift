...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //func getIotHubClientHandle() -> IOTHUB_CLIENT_LL_HANDLE {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        //(window?.rootViewController as! ViewController).iotHubClientHandle = iotHubClientHandle
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        //(window?.rootViewController as! ViewController).iotHubClientHandle = nil
    }
